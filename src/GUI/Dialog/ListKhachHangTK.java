...
public class ListKhachHangTK extends JDialog implements MouseListener {
    ...
    public ListKhachHangTK(TaiKhoanKH taoPhieuXuat, JFrame owner, String title, boolean modal){
        super(owner, title, modal);
        this.taikhoan=taoPhieuXuat;
        init();
