...
public class MenuTaskbar extends JPanel {
  ...
  //  PhieuNhap1 phieuNhap1;// aka chi tiết lô
    ...
    String[][] getSt = {
        ...
        {"Sản phẩm", "bookHieu.svg", "sanpham"},
        {"Khu vực sách", "khu_vuc.svg", "khuvucsach"},
        {"Lô", "khu_vuc.svg", "khuvucsach"},
      {"Mã khuyến mãi", "sale_Hieu.svg", "makhuyenmai"},
    ...
    private void initComponent() {
        ...
        pnlCenter.setPreferredSize(new Dimension(230, 620));
        ...
        listitem.get(3).addMouseListener(new MouseAdapter() {
            @Override
            public void mousePressed(java.awt.event.MouseEvent evt) {
                quanLyKho1 = new KhuVucSach1(main);
                main.setPanel(quanLyKho1);
            }
        });
...
//        });
    ...
    public void mousePressed(MouseEvent evt) {
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Có lỗi xảy ra khi mở Phiếu xuất: " + e.getMessage(), "Lỗi", JOptionPane.ERROR_MESSAGE);
        }
    }
});
